  ...
  return (
    <div className="flex w-full flex-col rounded-[25px] border-t-2 border-[#2F2E5F] bg-[#27264E] shadow-lg">
      <div
        ...
        className="flex h-20 items-center border-b-2 border-[#393869] bg-[#201F48] bg-opacity-70 p-6"
      >
      ...
      <div className="flex flex-col gap-2 px-6 py-4">
        ...
        >
          ...
          <span className="mx-auto w-[100px] text-center">Pot Value</span>
        ...
        <div className="flex max-h-[312px] flex-col gap-2 overflow-y-scroll scrollbar-hide [&>*:nth-child(even)]:bg-[#201F48]">
          {historyQuery.isSuccess
            ? (() => {
                ...
                const sessions = historyQuery.data.sessions.slice(
                  index1,
                  index2
                );

                return sessions.map((session) => {
                  const room = historyQuery.data.rooms[session.roomId];
                  ...
                  const win = publicKey === session.result.winner;
