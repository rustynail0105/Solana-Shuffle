...
import { adjustSpinValue } from "../../util/util";
    ...
    <div className="flex w-full flex-col text-left">
      ...
      <div className="mx-auto mt-6 w-3/4 max-w-xs">
        <AspectRatio ratio={1 / 1}>
          <Wheel users={users} value={value} result={result} token={token} />
        </AspectRatio>
      </div>
      <div className="mt-4">
...
const Wheel = ({ users, value, result, token }) => {
  ...
  useEffect(() => {
    ...
    let spinValue = adjustSpinValue(users, value, result.spinValue);
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <motion.div
        ...
        className="border-1 absolute top-0 left-0 h-full w-full
                rounded-full border-white shadow-lg"
      >
        {(() => {
          let lastPercentage = 0;
