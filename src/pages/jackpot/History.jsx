  ...
  return (
    <div className="relative flex w-full items-center gap-4 rounded-lg p-4">
      <div className="absolute top-4 right-4">
        <span className="text-[0.5rem] font-semibold text-mute 3xs:text-sm">
      ...
      <div
        style={{
          height: wheelRef.current ? wheelRef.current.clientHeight : 0,
        }}
        className="flex h-full flex-1 flex-col justify-center"
      >
        <div className="flex flex-col">
          <label className="text-[0.5rem] font-semibold text-mute 3xs:text-xs sm:text-sm lg:text-xs xl:text-sm">
            Value
          </label>
          <span className="-mt-1 text-[0.7rem] font-semibold 3xs:text-base sm:text-lg lg:text-base xl:text-lg">
        ...
        <div className="flex flex-col">
          ...
          >
            <span
              ...
              className="-mt-1 text-[0.7rem] font-semibold underline 3xs:text-base sm:text-lg lg:text-base xl:text-lg"
            >
        ...
        <div className="flex flex-col">
          ...
          <span
            className={
              `-mt-1 text-[0.7rem] font-semibold 3xs:text-base sm:text-lg lg:text-base xl:text-lg ` +
              (() => {
                if (winnerChance <= 25) {
                  return "text-red";
                }
      ...
      >
        <img className="w-3 3xs:w-6" src={right} alt="" />
        <span className="text-[0.5rem] font-semibold text-mute 3xs:text-sm">
          Replay
        </span>
      </button>
...
const History = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-x-8 gap-y-4 rounded-3xl border-2 border-[#2F2E5F] bg-[#25244E] p-4">
      ...
      {historyQuery.isSuccess ? (
        <div className="flex flex-col gap-4 [&>*:nth-child(odd)]:bg-[#201F48]">
          {(() => {
            ...
            const historySlice = historyQuery.data.slice(firstIndex, lastIndex);
